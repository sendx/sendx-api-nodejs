...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactResponse', 'model/Contact', 'model/TrackResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ContactResponse'), require('../model/Contact'), require('../model/TrackResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SendXRestApi) {
      root.SendXRestApi = {};
    }
    root.SendXRestApi.ContactApi = factory(root.SendXRestApi.ApiClient, root.SendXRestApi.ContactResponse, root.SendXRestApi.Contact, root.SendXRestApi.TrackResponse);
  }
}(this, function(ApiClient, ContactResponse, Contact, TrackResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} apiKey 
     * @param {String} teamId 
     * @param {module:model/Contact} body Contact details
     ...
     */
    this.contactIdentifyPost = function(apiKey, teamId, body, callback) {
      var postBody = body;
      ...
      if (body == undefined || body == null) {
        throw new Error("Missing the required parameter 'body' when calling contactIdentifyPost");
      }
     ...
     */
    this.contactTrackPost = function(apiKey, teamId, contactId, tag, callback) {
      var postBody = null;
      ...
      if (contactId == undefined || contactId == null) {
        throw new Error("Missing the required parameter 'contactId' when calling contactTrackPost");
      }
