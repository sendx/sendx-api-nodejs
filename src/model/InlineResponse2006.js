...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendXApi.InlineResponse2006 = factory(root.SendXApi.ApiClient, root.SendXApi.Link);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = Link.constructFromObject(data['data']);
      }
    }
    return obj;
  }
