...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendXApi.DeepListEmailContact();
  });
  ...
  describe('DeepListEmailContact', function() {
    it('should create an instance of DeepListEmailContact', function() {
      // uncomment below and update the code to test DeepListEmailContact
      //var instane = new SendXApi.DeepListEmailContact();
      //expect(instance).to.be.a(SendXApi.DeepListEmailContact);
    });
