...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendXRestApi.ContactApi();
  });
  ...
  describe('ContactApi', function() {
    describe('contactIdentifyPost', function() {
      it('should call contactIdentifyPost successfully', function(done) {
        //uncomment below and update the code to test contactIdentifyPost
        //instance.contactIdentifyPost(function(error) {
    ...
    describe('contactTrackPost', function() {
      it('should call contactTrackPost successfully', function(done) {
        //uncomment below and update the code to test contactTrackPost
        //instance.contactTrackPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
